...
func readUint8*(s: string, i: int): uint8 {.inline.} =
  s[i].uint8

func writeUint8*(s: var string, i: int, v: uint8) {.inline.} =
  s[i] = v.char

func addUint8*(s: var string, v: uint8) {.inline.} =
  s.add v.char
...
when defined(js):
  ...
  func readUint16*(s: string, i: int): uint16 {.inline.} =
    result = cast[ptr uint16](s[i].unsafeAddr)[]

  func writeUint16*(s: var string, i: int, v: uint16) {.inline.} =
    cast[ptr uint16](s[i].addr)[] = v

  func addUint16*(s: var string, v: uint16) {.inline.} =
  ...
  func writeUint32*(s: var string, i: int, v: uint32) {.inline.} =
  ...
  func readUint64*(s: string, i: int): uint64 {.inline.} =
    result = cast[ptr uint64](s[i].unsafeAddr)[]

  func writeUint64*(s: var string, i: int, v: uint64) {.inline.} =
...
func readInt8*(s: string, i: int): int8 {.inline.} =
  cast[int8](s.readUint8(i))

func writeInt8*(s: var string, i: int, v: int8) {.inline.} =
  s.writeUint8(i, cast[uint8](v))

func addInt8*(s: var string, v: int8) {.inline.} =
  s.addUint8(cast[uint8](v))

func readInt16*(s: string, i: int): int16 {.inline.} =
  cast[int16](s.readUint16(i))

func writeInt16*(s: var string, i: int, v: int16) {.inline.} =
  s.writeUint16(i, cast[uint16](v))

func addInt16*(s: var string, i: int16) {.inline.} =
  s.addUint16(cast[uint16](i))

func readInt32*(s: string, i: int): int32 {.inline.} =
  cast[int32](s.readUint32(i))

func writeInt32*(s: var string, i: int, v: int32) {.inline.} =
  s.writeUint32(i, cast[uint32](v))

func addInt32*(s: var string, i: int32) {.inline.} =
  s.addUint32(cast[uint32](i))

func readInt64*(s: string, i: int): int64 {.inline.} =
  cast[int64](s.readUint64(i))

func writeInt64*(s: var string, i: int, v: int64) {.inline.} =
  s.writeUint64(i, cast[uint64](v))

func addInt64*(s: var string, i: int64) {.inline.} =
  s.addUint64(cast[uint64](i))

func readFloat32*(s: string, i: int): float32 {.inline.} =
  cast[float32](s.readUint32(i))

func addFloat32*(s: var string, v: float32) {.inline.} =
  s.addUint32(cast[uint32](v))

func readFloat64*(s: string, i: int): float64 {.inline.} =
  cast[float64](s.readUint64(i))

func addFloat64*(s: var string, v: float64) {.inline.} =
